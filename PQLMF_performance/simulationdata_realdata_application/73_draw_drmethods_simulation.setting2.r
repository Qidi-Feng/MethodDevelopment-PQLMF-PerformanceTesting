...
irpt <- 1
num_pc <- 10
for (marker_start in c(1, 61, 91, 151)){
print(marker_start)
for (simu_time in seq(1,10)){
idata <- paste0("time",simu_time,".m_sigmag_sq0.1.nm_sigmag_sq0.001.sigmae_sq0.1.marker_number",marker_number,".marker_start",marker_start,".prop0.2.mu1.simu.rds")
	...
	res <- readRDS(file)
		...
		true_marker_prop <- (150-marker_start+1)/marker_number
...
save(data_total_sub, file=paste0(figure_path,"res.m_sigmag_sq0.1.nm_sigmag_sq0.001.sigmae_sq0.1.marker_number150.prop0.2.mu1.simu.nPC10.rpt1.allDRmethods.setting2.RData")) 
pngfile=paste0(figure_path,"res.m_sigmag_sq0.1.nm_sigmag_sq0.001.sigmae_sq0.1.marker_number150.prop0.2.mu1.simu.nPC10.rpt1.allDRmethods.setting2.png") 
png(pngfile)
