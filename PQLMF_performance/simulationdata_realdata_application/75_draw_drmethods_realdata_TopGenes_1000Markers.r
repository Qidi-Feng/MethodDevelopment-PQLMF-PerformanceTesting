...
save(data, file=paste0(figure_path, "res.",idata,".nPC",num_pc,".rpt",irpt,".allDRmethods.top2000.marker1000.RData"))
library(ggplot2)
pngfile=paste0(figure_path,"res.",idata,".nPC",num_pc,".rpt",irpt,".allDRmethods.top2000.marker1000.png")
