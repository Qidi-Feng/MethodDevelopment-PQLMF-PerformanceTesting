...
for marker_start in 1 61 91 151; do
	...
	Rscript /net/mulan/home/qidif/scRNA_Method/Res_Summary/DRComparison-master/mycode/44_simulation_lowIntercept_truemarker_setting2.r ${time} ${m_sigmag_sq} ${nm_sigmag_sq} ${sigmae_sq} ${marker_number} ${prop} ${marker_start}
	fi
done
done
done
